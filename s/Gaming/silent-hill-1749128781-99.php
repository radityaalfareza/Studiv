...
<html lang="en">
  ...
  <body class="bg-gray-100 min-h-screen flex flex-col">
    ...
    <main class="flex-grow max-w-4xl mx-auto px-4 py-8">
      <article class="bg-white rounded-md shadow-md p-6 mb-8" style="width:100vh;">
        <div class="text-xs text-gray-500 mb-3">
          <a class="font-semibold text-blue-600 hover:underline" href="/s/gaming.php">Gaming</a>
          <span>• Posted by Adam</span>
        </div>
        <h1 class="text-2xl font-extrabold text-gray-900 mb-4">Silent Hill</h1>
        <p class="text-gray-700 mb-4">scawy</p>
                <img class="rounded-md mb-4 w-full object-cover" src="https://imgs.search.brave.com/HpYBRBy0goYedFpGHuFhkhTMi8u6cfjQeXJfMt_27fs/rs:fit:500:0:0:0/g:ce/aHR0cHM6Ly9tLm1l/ZGlhLWFtYXpvbi5j/b20vaW1hZ2VzL00v/TVY1Qk5tTmpabUUz/TXpRdFpXRTJaQzAw/WVRka0xUaGhOekl0/TXpKa1lUTXlNelpo/T0RSbVhrRXlYa0Zx/Y0djQC5qcGc" alt="Post Image" />
      </article>
      <section>
        <!-- Comment Form -->
    ...
    <script>
      const postId = <?php echo json_encode(99); ?>;
