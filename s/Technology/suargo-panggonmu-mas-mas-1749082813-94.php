    ...
    <main class="flex-grow max-w-4xl mx-auto px-4 py-8">
      <article class="bg-white rounded-md shadow-md p-6 mb-8" style="width:100vh;">
        <div class="text-xs text-gray-500 mb-3">
          ...
          <span>• Posted by Alpinj</span>
        </div>
        <h1 class="text-2xl font-extrabold text-gray-900 mb-4">Suargo Panggonmu mas mas</h1>
        <p class="text-gray-700 mb-4">Ini adalah foto terakhir saya melihat mereka secara langsung. Momen ini terekam begitu jelas dalam ingatan saya, karena tidak pernah terpikir bahwa itulah pertemuan terakhir kami. Tatapan mereka, senyuman yang diberikan, semuanya terasa begitu hangat dan nyata pada saat itu.<br />
<br />
Setelah momen itu, saya tidak pernah lagi berkesempatan bertemu mereka. Kehidupan membawa kami pada jalan yang berbeda, dan waktu seolah terus berjalan tanpa memberi jeda. Kini yang tersisa hanyalah kenangan dalam foto ini, yang akan selalu saya simpan sebagai pengingat betapa berharganya waktu bersama orang-orang yang kita cintai.<br />
</p>
                <img class="rounded-md mb-4 w-full object-cover" src="https://i.imgur.com/6MF71vE.jpeg" alt="Post Image" />
      </article>
      <section>
        <!-- Comment Form -->
    ...
    <script>
      const postId = <?php echo json_encode(94); ?>;
