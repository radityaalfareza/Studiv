...
<html lang="en">
  <head>
    ...
    <title>AI CINA</title> <script src="https://cdn.tailwindcss.com"></script>
  ...
  <body class="bg-gray-100 min-h-screen flex flex-col">
    ...
    <main class="flex-grow max-w-4xl mx-auto px-4 py-8">
      <article class="bg-white rounded-md shadow-md p-6 mb-8" style="width:100vh;">
        <div class="text-xs text-gray-500 mb-3">
          ...
          <span>• Posted by Adam</span>
        </div>
        <h1 class="text-2xl font-extrabold text-gray-900 mb-4">AI CINA</h1>
        <p class="text-gray-700 mb-4">你好！😊 你想问什么呢？如果有任何问题或需要帮助，尽管告诉我，我会尽力解答！</p>
                <img class="rounded-md mb-4 w-full object-cover" src="https://imgs.search.brave.com/sDtqnDpeKca7l0Uc8ECGRpLubpo498JFdCiKlEKtMkc/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly90aHVt/YnMuZHJlYW1zdGlt/ZS5jb20vYi9taWNy/b2NoaXAtZmVhdHVy/aW5nLWNoaW5lc2Ut/ZmxhZy1zeW1ib2xp/emVzLWNoaW5hLXMt/ZG9taW5hbmNlLXRl/Y2hub2xvZ3ktYWkt/YWR2YW5jZW1lbnRz/LWFydGlmaWNpYWwt/aW50ZWxsaWdlbmNl/LTMzMjgzMzUwMy5q/cGc" alt="Post Image" />
      </article>
      <section>
        ...
        <ul id="comments-list" class="space-y-6">
          ...
          $postId = 103; // <-- Hapus backslash di sini
    ...
    <script>
      const postId = <?php echo json_encode(103); ?>; // <-- Hapus backslash di sini
