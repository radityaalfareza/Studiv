...
<html lang="en">
  <head>
    ...
    <title>sapi</title> <script src="https://cdn.tailwindcss.com"></script>
  ...
  <body class="bg-gray-100 min-h-screen flex flex-col">
    ...
    <main class="flex-grow max-w-4xl mx-auto px-4 py-8">
      <article class="bg-white rounded-md shadow-md p-6 mb-8" style="width:100vh;">
        ...
        <h1 class="text-2xl font-extrabold text-gray-900 mb-4">sapi</h1>
        <p class="text-gray-700 mb-4">Sebagai model bahasa besar, saya dikembangkan di Google.</p>
                <img class="rounded-md mb-4 w-full object-cover" src="/uploads/post_images/img_68466e8d3044c7.10148672.png" alt="Post Image" />
      </article>
      <section>
    ...
    <script>
      const postId = <?php echo json_encode(107); ?>;
