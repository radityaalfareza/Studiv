...
<html lang="en">
  ...
  <body class="bg-gray-100 min-h-screen flex flex-col">
    ...
    <main class="flex-grow max-w-4xl mx-auto px-4 py-8">
      <article class="bg-white rounded-md shadow-md p-6 mb-8" style="width:100vh;">
        <div class="text-xs text-gray-500 mb-3">
          <a class="font-semibold text-blue-600 hover:underline" href="/s/funny.php">Funny</a>
          <span>• Posted by ss32ki</span>
        </div>
        <h1 class="text-2xl font-extrabold text-gray-900 mb-4">Pantun</h1>
        <p class="text-gray-700 mb-4">Roses are red, violets are blue, are you a map? Because I&#039;m lost without you.</p>
                <img class="rounded-md mb-4 w-full object-cover" src="https://www.instagram.com/p/CcPuliNLbrO/" alt="Post Image" />
      </article>
      <section>
        <!-- Comment Form -->
    ...
    <script>
      const postId = <?php echo json_encode(100); ?>;
