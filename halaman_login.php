...
<body class="bg-gray-100 min-h-screen flex flex-col">
    ...
    <main class="flex-grow flex items-center justify-center px-4 py-12">
        <div class="max-w-md w-full bg-white rounded-md shadow-md p-8">
            <h1 class="text-3xl font-extrabold text-gray-900 mb-6 text-center">Login</h1>
            <form class="space-y-6" action="proses/proses_login.php" method="post" autocomplete="off">
                <div>
                ...
                <!-- ✅ reCAPTCHA v2 -->
                <div class="g-recaptcha" data-sitekey="6LepllkrAAAAAIZT064ax6bKT6CO-_wXMs8oARjC"></div>
            ...
            <p class="mt-6 text-center text-sm text-gray-600">
                Belum punya akun?
                <a href="halaman_register.php" class="font-medium text-blue-600 hover:text-blue-700">Daftar</a>
            </p>
        </div>
    </main>
