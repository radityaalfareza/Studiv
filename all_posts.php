...
<body class="bg-gray-100 min-h-screen flex flex-col">
    ...
    <main class="flex-grow max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <?php if (mysqli_num_rows($result_posts) === 0): ?>
            <div class="p-6 text-center text-gray-500 bg-white rounded-md shadow-md">
                You have no posts.
            </div>
        <?php else: ?>
            <div class="space-y-6">
                <?php while ($post = mysqli_fetch_assoc($result_posts)): ?>
                    <article class="bg-white rounded-md shadow-md p-6 hover:shadow-lg transition-shadow duration-200">
